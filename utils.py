...
from easy_ViTPose.inference import MEAN, STD, data_cfg
import matplotlib.pyplot as plt

path_keypoints = os.path.join("keypoints")
path_frames = os.path.join("frames")
...
def draw_keypoints(keypoints, img=None, dataset="coco_25", confidence_threshold=0.5):
    ...
    if isinstance(keypoints, str):
        keypoints = os.join(path_keypoints, keypoints)
